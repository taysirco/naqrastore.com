                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="text-center mb-12">
                            <span className="inline-block px-4 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-full text-sm font-bold mb-4">
                                🎧 {isRTL ? data.soundcoreSection.tagline.ar : data.soundcoreSection.tagline.en}
                            </span>
                            <h2 className="text-3xl md:text-4xl font-black mb-4 dark:text-white">
                                {isRTL ? data.soundcoreSection.title.ar : data.soundcoreSection.title.en}
                            </h2>
                        ...
                        <div className="max-w-4xl mx-auto mb-12">
                            <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl border border-purple-100 dark:border-gray-700 shadow-lg">
                                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                                    {isRTL ? data.soundcoreSection.history.ar : data.soundcoreSection.history.en}
                                </p>
                            </div>
                        </div>
                        ...
                        {/* Achievements Grid */}
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-12">
                            {data.soundcoreSection.achievements.map((achievement, idx) => (
                        ...
                        <div className="max-w-5xl mx-auto mb-12">
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {data.soundcoreSection.technologies.map((tech, idx) => (
                        ...
                        <div className="max-w-4xl mx-auto mb-12">
                            <h3 className="text-2xl font-bold text-center mb-8 dark:text-white">
                                {isRTL ? 'صوت مثالي لكل لحظة' : 'Perfect Sound, Anytime, Anywhere'}
                            </h3>
                            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                                {data.soundcoreSection.useCases.map((useCase, idx) => (
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 border border-gray-100 dark:border-gray-800 mb-12">
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                                {data.soundcoreSection.trustBadges.map((badge, idx) => (
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="space-y-4">
                                {(isRTL ? data.soundcoreSection.faq.ar : data.soundcoreSection.faq.en).map((item, idx) => (
